...
exports.upload = function(buf, chunkSize, redundancy, stores, log, done) {
  ...
  async.map(chunks, function(chunk, nextChunk) {
    async.times(redundancy, function(n, nextStore) {
      var store = stores.push(stores.shift());
